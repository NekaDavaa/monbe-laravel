...
@section('content')
    ...
    <form class="max-w-lg mx-auto my-10 p-6 bg-white shadow-md rounded" method="POST" action="{{ route('articles.store')  }}">
        @csrf
        <div class="mb-4">
            <label for="title" class="block text-gray-700 text-sm font-bold mb-2">Title</label>
            <input type="text" id="title" name="article_title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-red-400 focus:ring-red-400" placeholder="Enter title">
        </div>
