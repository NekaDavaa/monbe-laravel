...
<form method="POST" action="{{ route('hi') }}">
    ...
    <label for="first_name" >What is your name?</label>
        ...
        <input type="text" id="first_name" name="first_name" required class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-red-400 sm:text-sm sm:leading-6" placeholder="Your Name" value="{{ old('first_name') }}">
