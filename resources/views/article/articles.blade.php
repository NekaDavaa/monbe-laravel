...
@section('content')
    <div class="flex justify-between items-center">
        ...
        @auth
        <a href="{{ route('articles.create') }}" class="text-yellow-700 text-3xl mb-4">
                ...
                <td class="px-6 py-4">
                    @auth
                        <div class="flex items-center">
                            <a href="/article/edit/{{ $article->id }}" class="text-blue-500 hover:text-blue-600 mr-4" aria-label="Edit">
                                <i class="fas fa-edit" title="Edit"></i>
                            </a>
                            <span class="text-gray-300">|</span>
                            <a href="/article/delete/{{ $article->id }}" class="text-red-500 hover:text-red-600 ml-4" aria-label="Delete">
